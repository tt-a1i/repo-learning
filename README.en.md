...
Turn an unfamiliar codebase into a visual, explorable guide for new contributors.
...
The output adapts to the repository. It can include an interactive architecture map, runtime flow stories, concept cards, a code atlas, quick-start commands, risks, and a contributor roadmap.
